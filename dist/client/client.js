...
const camera1 = new THREE.PerspectiveCamera(75, 1, 0.1, 200); //achter 0 staat nog iets
const camera2 = new THREE.OrthographicCamera(-1, 5, 1, -1, 3); //achter 0 staat nog iets
const camera3 = new THREE.OrthographicCamera(-6, 6, 6, -6, 10); //achter 0 staat nog iets
const camera4 = new THREE.OrthographicCamera(-4, 4, 4, -4, 10); //achter 0 staat nog iets
